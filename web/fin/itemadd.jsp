...
<script type="text/javascript">
    $(function () {
        $("#num").blur(function () {
            /*$.post("checkNum.action",{"num":$(this).val()},function (data){
                if("true"==data){
...
<div id="center">
    ...
    <form action="itemadd" method="post">
        <div class="input-group">
            ...
            <input type="text" name="item.num" class="form-control" id="num" placeholder="请输入新的商品编号">
        </div>
        <br/>
        <div class="input-group">
            <div class="input">
            ...
            <input type="text" name="item.title" class="form-control" placeholder="请输入商品的标题">
        </div>
        <br/>
        <div class="input-group">
            <div class="input">
            ...
            <input type="number" name="item.price" class="form-control" >
        </div>
        <br/>
        <div class="input-group">
            <div class="input">
            ...
            <input type="number" name="item.amount" class="form-control">
        </div>
        <br/>
        <div class="input-group">
            <div class="input">
